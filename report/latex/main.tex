...
\newpage
\input{contents/02_system_overview.tex}
\input{contents/03_hardware_implementation.tex}
\newpage
\input{contents/04_fpga_architecture.tex}
\input{contents/05_signal_processing.tex}
\input{contents/06_lut_classification.tex}
\input{contents/07_platform_tracking.tex}
\input{contents/08_pc_interface.tex}
\input{contents/09_results_discussion.tex}
\input{contents/10_conclusion.tex}
\begin{appendices}
